...
void utn_convertirIntACadena(int cadenaDeInt, char* intCovertidoAString){

char string[20];
char AuxintCovertidoAString[20];

	strcpy(AuxintCovertidoAString, itoa(cadenaDeInt,string,10));
	intCovertidoAString = AuxintCovertidoAString;
	return;
}
