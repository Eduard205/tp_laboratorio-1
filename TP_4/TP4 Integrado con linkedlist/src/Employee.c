...
int employee_setId(Employee* this, int id){
	int rtn=-1;
	//char intCovertidoAString[20];

	//utn_convertirIntACadena(id, intCovertidoAString);

		if(this != NULL && id > 0 /*&& esNumeroValidacion(intCovertidoAString)==0*/)
		{
			this->id = id;
			rtn = 0;
		}
...
int employee_setHorasTrabajadas(Employee* this, int horasTrabajadas){
	...
	//utn_convertirIntACadena(horasTrabajadas, intCovertidoAString);

		if(this != NULL && horasTrabajadas > -1 /*&& esNumeroValidacion(intCovertidoAString)==0*/)
		{
...
int employee_setSueldo(Employee* this, int sueldo){
	...
	//utn_convertirIntACadena(sueldo, intCovertidoAString);

		if(this != NULL && sueldo > -1 /*&& esNumeroValidacion(intCovertidoAString)==0*/)
		{
			this->sueldo = sueldo;
			rtn = 0;
		}
